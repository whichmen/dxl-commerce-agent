...
private const val PREFS_NAME = "qianniu_worker_prefs"
...
object WorkerPrefs {
    ...
    fun isAccessibilityEnabled(context: Context): Boolean {
        val component = "${context.packageName}/${QianNiuAccessibilityService::class.java.name}"
        val enabled = try {
