...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnOpenQianNiu).setOnClickListener {
            val pm = packageManager
            val launchIntent = pm.getLaunchIntentForPackage("com.taobao.qianniu")
            ...
            val explicit = Intent().apply {
                component = ComponentName(
                    "com.taobao.qianniu",
                    "com.qianniu.launcher.business.main.MainActivity",
                )
            ...
            if (!ok) {
                Toast.makeText(this, "未找到千牛App", Toast.LENGTH_SHORT).show()
            }
        }
    }
